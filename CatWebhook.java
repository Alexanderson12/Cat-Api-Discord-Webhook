...
public class CatWebhook {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String catApiUrl = "https://api.thecatapi.com/v1/images/search?size=full&mime_types=jpg,png,gif&limit=1&format=json&api_key=live_vAEviySb7LZuhoIqqFjs8QkVaaNXd2HWd8XobXB2hyjEXHgUQH4xAxDBhChWVzBZ";
        ...
        while (true) {
            try {
                String urlImagemResponse = sendRequestApiCat(payload, imageUrl, url);
    ...
    private static String sendRequestApiCat(JSONObject payload, String imageUrl, URL url) {
        try {
